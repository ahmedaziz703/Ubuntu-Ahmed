    ...
    <>
      ...
      <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          ...
          up{" "}
          <a className="text-underline" href="mailto:ahmedaziz703@gmail.com">
            <u>ahmedaziz703@gmail.com</u>
          </a>{" "}
          :) )
        </li>
        ...
        <li className=" mt-3 list-time">
          ...
          <a
            href="https://www.youtube.com/channel/@mrbeast?si=66OL_NOWOPq_mbE"
            target="_blank"
            rel="noreferrer">
            {" "}
            Mrbeast videos.
    ...
    <>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        <li className="list-disc">
          ...
          <div className=" text-sm md:text-base">IT Eng</div>
        ...
        <li className="list-disc">
          <div className=" text-lg md:text-xl text-left font-bold leading-tight">
           Al Rashid Modern school
          </div>
          <div className=" text-sm text-gray-400 mt-0.5">2018 - 2019</div>
          <div className=" text-sm md:text-base">Cybersecurity technician</div>
          <div className="text-sm text-gray-300 font-bold mt-1">
            CGPA &nbsp; 8.0/10
          </div>
        </li>
